...
CREATE TABLE `accounts` (
  ...
  `control_number` varbinary(255) DEFAULT NULL,
  PRIMARY KEY (`id`,`firstname`)
) ENGINE=InnoDB AUTO_INCREMENT=37 DEFAULT CHARSET=latin1;

/*Data for the table `accounts` */

insert  into `accounts`(`id`,`firstname`,`lastname`,`mi`,`birthday`,`username`,`password`,`created_at`,`updated_at`,`isAdmin`,`img_url`,`isDeleted`,`gender`,`mobile_number`,`control_number`) values (1,'Eddard','Stark','A','1990-01-25','nedd','$2y$10$tJEuASj2hPdPrLqfj83Vi.PrSlFRf.nWJ24jRU4egzFD4z2q90G8a','2018-01-20 13:53:06','2018-01-20 13:53:06',0,'../assets/img/avatar/1.png',0,'Male','639171101126','2018-1000000'),(2,'Daenarys','Stormborn','R','1990-11-12','daenarys','$2y$10$d92o1grFmk7wxhhBLJOgC.gnHAseGAzD76iVp/Aikj1q3ZbBMxZcW','2018-01-22 11:45:20','2018-01-22 11:45:20',0,'../assets/img/avatar/2.jpg',0,'Female','639171101126','2018-1000001'),(5,'John','Snow','B','1990-01-01','johnsnow','$2y$10$d92o1grFmk7wxhhBLJOgC.gnHAseGAzD76iVp/Aikj1q3ZbBMxZcW','2018-01-22 18:07:08','2018-01-22 18:07:08',0,'../assets/img/avatar/5.png',0,'Male','639171101126','2018-1000002'),(7,'Administrator','Administrator','A','1990-11-26','admin','$2y$10$d92o1grFmk7wxhhBLJOgC.gnHAseGAzD76iVp/Aikj1q3ZbBMxZcW','2018-01-25 20:17:49','2018-01-25 20:17:49',1,'../assets/img/avatar/7.jpg',0,'Male','639171101126','2018-1000003'),(33,'Ashbee','Morgado','Ashbee','1994-11-26','testaccount','$2y$10$1dNLH9TdwKvu.ILIU9XKuOq.NzpRMMLP3evHNvGdUUeeI0e4psH9a','2018-02-08 14:50:16','2018-02-08 14:50:16',0,'../assets/img/avatar/default.png',0,'Male','639171101126','2018-1000004'),(34,'dasda','sdasdsad','Allego','2000-11-11','asdas','$2y$10$FIkNFGYDd1F2I/YlH2gpKeMhlyDP0Sv3L/FmNRWUdcL7CaSkEFCo6','2018-02-08 16:21:32','2018-02-08 16:21:32',0,'../assets/img/avatar/default.png',0,'Male','631955668888','2018-1000005'),(35,'Ashbee','Morgado','Ashbee','1994-11-26','ashashbee','$2y$10$18q7phkbdzkREmmd5rhslOnloz69KjcuNPCbyPWQYxLiXKoCp1G7O','2018-02-12 15:50:45','2018-02-12 15:50:45',0,'../assets/img/avatar/default.png',0,'Male','639171101126','2018-1000006'),(36,'Ashbee','Morgado','Allego','1994-11-26','primoashbee','$2y$10$4TKdKhU918CscVh8q5poK.3QSN0tPuiaWyRX.gR64lUFpv7AWVJb6','2018-02-13 16:44:51','2018-02-13 16:44:51',0,'../assets/img/avatar/default.png',0,'Male','639171101126','2018-1000007');
...
insert  into `bills`(`id`,`property_id`,`billing_year`,`billing_month`,`amount`,`created_at`,`isPaid`) values (55,3,'2018','2','13450','2018-02-12 13:41:52',0),(56,1,'2018','2','1500','2018-02-12 14:01:24',1),(57,4,'2018','2','15000','2018-02-12 14:01:24',0),(58,16,'2018','2','92000','2018-02-12 14:01:24',0),(59,17,'2018','2','10000','2018-02-12 14:01:24',0),(60,18,'2018','2','10000','2018-02-13 13:34:01',0);
...
insert  into `cms_slides`(`id`,`tagline`,`subtitle`,`img_url`,`isDeleted`,`create_at`) values (1,'City Treasurer\'s Balanga','Subtitle','website/images/wallpaper1.jpg',0,'2018-02-01 09:36:44'),(2,'Valar Dohaeris','Subtitle','website/images/wallpaper2.jpg',0,'2018-02-01 09:37:29'),(3,'Valar Morghulis','Subtitle','website/images/wallpaper3.jpg',0,'2018-02-01 09:37:40');
...
CREATE TABLE `news` (
  `id` int(15) unsigned NOT NULL AUTO_INCREMENT,
  `headline` varbinary(255) DEFAULT NULL,
  `body` longtext,
  `created_at` timestamp NULL DEFAULT CURRENT_TIMESTAMP,
  PRIMARY KEY (`id`)
...
insert  into `news`(`id`,`headline`,`body`,`created_at`) values (1,'NEWS #1','Lorem Ipsum is simply dummy text of the printing and typesetting industry.\r\nLorem Ipsum has been the industry\'s standard dummy text ever since the 1500s, when an unknown printer took a galley of type and scrambled it to make a type specimen book. It has survived not only five centuries, but also the leap into electronic typesetting, remaining essentially unchanged. It was popularised in the 1960s with the release of Letraset sheets containing Lorem Ipsum passages, and more recently with desktop publishing software like Aldus PageMaker including versions of Lorem Ipsum.\r\nLorem Ipsum is simply dummy text of the printing and typesetting industry.\r\nLorem Ipsum has been the industry\'s standard dummy text ever since the 1500s, when an unknown printer took a galley of type and scrambled it to make a type specimen book. It has survived not only five centuries, but also the leap into electronic typesetting, remaining essentially unchanged. It was popularised in the 1960s with the release of Letraset sheets containing Lorem Ipsum passages, and more recently with desktop publishing software like Aldus PageMaker including versions of Lorem Ipsum.','2018-02-13 14:51:57'),(2,'NEWS #2','Lorem Ipsum is simply dummy text of the printing and typesetting industry.\r\nLorem Ipsum has been the industry\'s standard dummy text ever since the 1500s, when an unknown printer took a galley of type and scrambled it to make a type specimen book. It has survived not only five centuries, but also the leap into electronic typesetting, remaining essentially unchanged. It was popularised in the 1960s with the release of Letraset sheets containing Lorem Ipsum passages, and more recently with desktop publishing software like Aldus PageMaker including versions of Lorem Ipsum.\r\nLorem Ipsum is simply dummy text of the printing and typesetting industry.\r\nLorem Ipsum has been the industry\'s standard dummy text ever since the 1500s, when an unknown printer took a galley of type and scrambled it to make a type specimen book. It has survived not only five centuries, but also the leap into electronic typesetting, remaining essentially unchanged. It was popularised in the 1960s with the release of Letraset sheets containing Lorem Ipsum passages, and more recently with desktop publishing software like Aldus PageMaker including versions of Lorem Ipsum.','2018-02-13 14:54:29'),(3,'NEWS #3','Lorem Ipsum is simply dummy text of the printing and typesetting industry.\r\nLorem Ipsum has been the industry\'s standard dummy text ever since the 1500s, when an unknown printer took a galley of type and scrambled it to make a type specimen book. It has survived not only five centuries, but also the leap into electronic typesetting, remaining essentially unchanged. It was popularised in the 1960s with the release of Letraset sheets containing Lorem Ipsum passages, and more recently with desktop publishing software like Aldus PageMaker including versions of Lorem Ipsum.\r\nLorem Ipsum is simply dummy text of the printing and typesetting industry.\r\nLorem Ipsum has been the industry\'s standard dummy text ever since the 1500s, when an unknown printer took a galley of type and scrambled it to make a type specimen book. It has survived not only five centuries, but also the leap into electronic typesetting, remaining essentially unchanged. It was popularised in the 1960s with the release of Letraset sheets containing Lorem Ipsum passages, and more recently with desktop publishing software like Aldus PageMaker including versions of Lorem Ipsum.','2018-02-13 15:28:09'),(4,'NEWS #4','Lorem Ipsum is simply dummy text of the printing and typesetting industry.\r\nLorem Ipsum has been the industry\'s standard dummy text ever since the 1500s, when an unknown printer took a galley of type and scrambled it to make a type specimen book. It has survived not only five centuries, but also the leap into electronic typesetting, remaining essentially unchanged. It was popularised in the 1960s with the release of Letraset sheets containing Lorem Ipsum passages, and more recently with desktop publishing software like Aldus PageMaker including versions of Lorem Ipsum.\r\nLorem Ipsum is simply dummy text of the printing and typesetting industry.\r\nLorem Ipsum has been the industry\'s standard dummy text ever since the 1500s, when an unknown printer took a galley of type and scrambled it to make a type specimen book. It has survived not only five centuries, but also the leap into electronic typesetting, remaining essentially unchanged. It was popularised in the 1960s with the release of Letraset sheets containing Lorem Ipsum passages, and more recently with desktop publishing software like Aldus PageMaker including versions of Lorem Ipsum.','2018-02-13 15:28:30'),(5,'News #5','Lorem Ipsum is simply dummy text of the printing and typesetting industry.\r\nLorem Ipsum has been the industry\'s standard dummy text ever since the 1500s, when an unknown printer took a galley of type and scrambled it to make a type specimen book. It has survived not only five centuries, but also the leap into electronic typesetting, remaining essentially unchanged. It was popularised in the 1960s with the release of Letraset sheets containing Lorem Ipsum passages, and more recently with desktop publishing software like Aldus PageMaker including versions of Lorem Ipsum.\r\nLorem Ipsum is simply dummy text of the printing and typesetting industry.\r\nLorem Ipsum has been the industry\'s standard dummy text ever since the 1500s, when an unknown printer took a galley of type and scrambled it to make a type specimen book. It has survived not only five centuries, but also the leap into electronic typesetting, remaining essentially unchanged. It was popularised in the 1960s with the release of Letraset sheets containing Lorem Ipsum passages, and more recently with desktop publishing software like Aldus PageMaker including versions of Lorem Ipsum.','2018-02-13 16:09:05');
...
insert  into `payments`(`id`,`billing_id`,`amount_paid`,`created_at`,`updated_at`,`checkout_id`) values (9,56,NULL,'2018-02-12 15:28:47','2018-02-12 15:28:47','ec29c1c9-15a6-42e4-a297-e249dfe1c25c');
